...
int DXTCompressImage(LPCSTR out_name, u8* raw_data, u32 w, u32 h, u32 pitch, STextureParams* fmt, u32 depth)
{
	...
	Msg("DXTCompressImage: Stage 1; name = %s, width = %u, h = %h, pitch = %u", out_name, w, h, pitch);
    ...
    else
    {
		...
		Msg("DXTCompressImage: Alternative Stage: RGBAImage");
