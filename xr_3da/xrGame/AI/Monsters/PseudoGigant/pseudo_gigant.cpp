...
void CPseudoGigant::on_threaten_execute()
{
	...
	Level().Cameras().AddPPEffector(xr_new<CMonsterEffector>(m_threaten_effector.ppi, m_threaten_effector.time, m_threaten_effector.time_attack, m_threaten_effector.time_release));
